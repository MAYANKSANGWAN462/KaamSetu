    ...
    <div className="min-h-screen bg-[#f6f7f9] dark:bg-[#0b0e14] pt-24 pb-12">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <motion.div {...stagger(1)}
          className="bg-white dark:bg-white/[0.04] rounded-3xl border border-[#e6e8ec] dark:border-white/8 p-7 shadow-sm">
          {fetching ? (
            <div className="space-y-4 animate-pulse">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="h-12 bg-[#e6e8ec] dark:bg-white/10 rounded-2xl" />
              ))}
            </div>
          ) : (
