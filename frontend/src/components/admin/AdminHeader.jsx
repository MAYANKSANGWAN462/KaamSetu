...
const AdminHeader = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0d1117]/95 dark:bg-[#0b0e14]/98 backdrop-blur-xl border-b border-white/[0.07] shadow-lg shadow-black/20">
          ...
          <div className="flex items-center h-14 gap-3">
            ...
            <Link to="/admin" className="flex items-center gap-2.5 shrink-0">
              ...
              <div className="flex items-center gap-1.5">
                <span className="text-sm font-black text-white tracking-tight">KaamSetu</span>
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              {admin && (
                <div className="hidden sm:flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-white/[0.05] border border-white/[0.08]">
                  ...
                  <div className="hidden md:block">
                    <p className="text-[11px] font-bold text-white leading-tight max-w-[110px] truncate">
                      {admin.name || 'Admin'}
                    </p>
              ...
              <button
                ...
                title="Sign out"
                className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs font-bold text-gray-500 hover:text-red-400 hover:bg-red-500/10 border border-white/[0.08] hover:border-red-500/20 transition-all duration-200"
              >
        ...
        {/* Mobile sub-nav (nav links as a bottom strip on small screens) */}
